...
class GUI():
    def __init__(self, master):
        ...
        self.generate = Button(text="GENERATE PASSWORD", bd=3, relief='solid', padx=1, pady=1, font='Arial 12', fg='white', bg='darkblue', command=self.generate_pass)
        self.generate.grid(row=11, column=1)

        self.blank_label5 = Label(text="")
        self.blank_label5.grid(row=12, column=0)

        self.accept = Button(text="ACCEPT", bd=3, relief='solid', padx=1, pady=1, font='Arial 12', fg='darkblue', bg='white', command=self.accept_fields)
        self.accept.grid(row=13, column=1)

        self.blank_label1 = Label(text="")
        self.blank_label1.grid(row=14, column=1)

        self.reset = Button(text="RESET", bd=3, relief='solid', padx=1, pady=1, font='Arial 12', fg='darkblue', bg='white', command=self.reset_fields)
    ...
    def generate_pass(self):
        ...
        self.n_generatedpassword.set("")  # Clear the generated password
        ...
        self.n_generatedpassword.set(gen_passwd)  # Set the generated password to the variable
